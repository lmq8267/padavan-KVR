...
Currently available applets include:
	...
	addgroup, adduser, arp, arping, ascii, ash, awk, base64, basename,
	bash, brctl, bunzip2, bzcat, bzip2, cat, chgrp, chmod, chown,
	chpasswd, chroot, clear, cp, crc32, crond, crontab, cut, date, dd,
	df, dhcp6c, dirname, dmesg, dnsdomainname, dos2unix, du, echo,
	egrep, eject, env, ether-wake, expr, false, fdisk, fgrep, find,
	flock, free, fuser, getopt, grep, gunzip, gzip, head, hexdump,
	hostname, hwclock, ifconfig, inetd, insmod, kill, killall, klogd,
	ln, logger, login, ls, lsmod, lsof, md5sum, mdev, microcom, mkdir,
	mknod, mkswap, modinfo, modprobe, more, mount, mountpoint, mv, nc,
	netstat, nice, nohup, nslookup, ntpd, passwd, pgrep, pidof, ping,
	ping6, printf, ps, pwd, rm, rmdir, rmmod, route, sed, sendmail, seq,
	sh, sha256sum, sleep, sort, start-stop-daemon, stat, strings,
	swapoff, swapon, switch_root, sync, sysctl, syslogd, tail, tar, tee,
	telnet, telnetd, test, time, top, touch, tr, traceroute,
	traceroute6, true, udhcpc, umount, uname, uniq, unix2dos, unlink,
	unzip, uptime, usleep, vconfig, vi, watch, wc, wget, which, whoami,
	xargs, yes, zcat, zcip
...
Read user:password from stdin and update /etc/passwd
	...
	-c ALG	des,md5,sha256/512 (default m)
...
Change USER's password (default: current user)
	...
	-a ALG	des,md5,sha256/512 (default m)
	-d	Set password to ''
...
tar c|x|t [-zjahvokO] [-f TARFILE] [-C DIR] [-T FILE] [-X FILE] [FILE]...
...
udhcpc [-fbqvRB] [-a[MSEC]] [-t N] [-T SEC] [-A SEC|-n]
	...
	-i IFACE	Interface to use (default br0)
	-s PROG		Run PROG at DHCP events (default /tmp/udhcpc.script)
