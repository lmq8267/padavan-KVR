...
our %config = (
  AR => "ar",
  ARFLAGS => [ "r" ],
  AS => "/opt/5/00/trunk/../toolchain-mipsel/toolchain-3.4.x/bin/mipsel-linux-uclibc-as -mips32r2 -march=mips32r2 -mtune=1004kc",
  CC => "gcc",
  CFLAGS => [ "-mips32r2 -march=mips32r2 -mtune=1004kc -O3 -mips32r2 -march=mips32r2 -mtune=1004kc -fomit-frame-pointer -pipe -DEMBED -I/opt/5/00/trunk/stage/include -Dlinux -D__linux__ -Dunix -Wall -Wno-trigraphs -Wno-strict-aliasing -Wno-format-security -fno-tree-slsr -fno-aggressive-loop-optimizations -Wno-pointer-sign -Wno-unused -ffunction-sections -fdata-sections -DOPENSSL_USE_IPV6=1 -DOPENSSL_PREFER_CHACHA_OVER_GCM -DOPENSSL_USE_IPV6=1 -DOPENSSL_PREFER_CHACHA_OVER_GCM" ],
  CPPDEFINES => [  ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CROSS_COMPILE => "/opt/5/00/trunk/../toolchain-mipsel/toolchain-3.4.x/bin/mipsel-linux-uclibc-",
  CXX => "g++",
  ...
  LD => "/opt/5/00/trunk/../toolchain-mipsel/toolchain-3.4.x/bin/mipsel-linux-uclibc-ld",
  LDFLAGS => [ "-L/opt/5/00/trunk/stage/lib -Wl,--gc-sections" ],
  LDLIBS => [  ],
  PERL => "/usr/bin/perl",
  RANLIB => "ranlib",
  RC => "windres",
